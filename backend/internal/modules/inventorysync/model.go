...
type InventorySyncRun struct {
	...
	TenantID              int64          `gorm:"not null;index:idx_inventory_sync_runs_tenant_shop_status,priority:1" json:"tenantId"`
	ShopConnectionID      uuid.UUID      `gorm:"type:char(36);not null;index:idx_inventory_sync_runs_tenant_shop_status,priority:2" json:"shopConnectionId"`
	...
	Platform              string         `gorm:"size:64;not null;index:idx_inventory_sync_runs_tenant_shop_status,priority:3" json:"platform"`
	...
	Status                string         `gorm:"size:32;not null;index:idx_inventory_sync_runs_tenant_shop_status,priority:4" json:"status"`
...
func (InventorySyncRun) TableName() string { return "inventory_sync_runs" }

type InventorySnapshotItem struct {
	model.HardDeleteBase
	TenantID            int64            `gorm:"not null;uniqueIndex:ux_inventory_snapshots_tenant_run_external_sku,priority:1;index:idx_inventory_snapshots_tenant_run,priority:1" json:"tenantId"`
	InventorySyncRunID  uuid.UUID        `gorm:"type:char(36);not null;uniqueIndex:ux_inventory_snapshots_tenant_run_external_sku,priority:2;index:idx_inventory_snapshots_tenant_run,priority:2" json:"inventorySyncRunId"`
	...
	ShopConnectionID    uuid.UUID        `gorm:"type:char(36);not null;index:idx_inventory_snapshots_tenant_shop,priority:2" json:"shopConnectionId"`
	ShopConnection      shop.Shop        `gorm:"foreignKey:ShopConnectionID;references:ID;constraint:OnUpdate:CASCADE,OnDelete:RESTRICT;" json:"-"`
	...
	ExternalSKUID       string           `gorm:"column:external_sku_id;size:255;not null;uniqueIndex:ux_inventory_snapshots_tenant_run_external_sku,priority:3;index" json:"externalSkuId"`
...
func (InventorySnapshotItem) TableName() string              { return "inventory_snapshot_items" }
...
type SKUBinding struct {
	model.HardDeleteBase
	TenantID           int64              `gorm:"not null;index:idx_sku_bindings_tenant_external,priority:1;index:idx_sku_bindings_tenant_local,priority:1" json:"tenantId"`
	ShopConnectionID   uuid.UUID          `gorm:"type:char(36);not null;index:idx_sku_bindings_tenant_external,priority:2" json:"shopConnectionId"`
	ShopConnection     shop.Shop          `gorm:"foreignKey:ShopConnectionID;references:ID;constraint:OnUpdate:CASCADE,OnDelete:RESTRICT;" json:"-"`
	Platform           string             `gorm:"size:64;not null" json:"platform"`
	ExternalProductID  string             `gorm:"column:external_product_id;size:255;not null" json:"externalProductId"`
	ExternalSKUID      string             `gorm:"column:external_sku_id;size:255;not null;index:idx_sku_bindings_tenant_external,priority:3" json:"externalSkuId"`
	ExternalSKUCode    string             `gorm:"column:external_sku_code;size:255;index" json:"externalSkuCode,omitempty"`
	LocalProductID     uuid.UUID          `gorm:"column:local_product_id;type:char(36);not null;index:idx_sku_bindings_tenant_local,priority:2" json:"localProductId"`
	...
	LocalSKUID         uuid.UUID          `gorm:"column:local_sku_id;type:char(36);not null;index:idx_sku_bindings_tenant_local,priority:3" json:"localSkuId"`
...
func (SKUBinding) TableName() string { return "sku_bindings" }

type SKUBindingCalibration struct {
	model.HardDeleteBase
	TenantID                int64                 `gorm:"not null;uniqueIndex:ux_sku_calibrations_candidate_version,priority:1;index:idx_sku_calibrations_tenant_run,priority:1" json:"tenantId"`
	InventorySyncRunID      uuid.UUID             `gorm:"type:char(36);not null;uniqueIndex:ux_sku_calibrations_candidate_version,priority:2;index:idx_sku_calibrations_tenant_run,priority:2" json:"inventorySyncRunId"`
	InventorySyncRun        InventorySyncRun      `gorm:"foreignKey:InventorySyncRunID;references:ID;constraint:OnUpdate:CASCADE,OnDelete:RESTRICT;" json:"-"`
	InventorySnapshotItemID uuid.UUID             `gorm:"type:char(36);not null;uniqueIndex:ux_sku_calibrations_candidate_version,priority:3;index:idx_sku_calibrations_snapshot,priority:2" json:"inventorySnapshotItemId"`
	...
	CandidateLocalSKUID     uuid.UUID             `gorm:"column:candidate_local_sku_id;type:char(36);not null;uniqueIndex:ux_sku_calibrations_candidate_version,priority:4" json:"candidateLocalSkuId"`
	...
	CalibrationVersion      int                   `gorm:"not null;default:1;uniqueIndex:ux_sku_calibrations_candidate_version,priority:5" json:"calibrationVersion"`
	Status                  string                `gorm:"size:32;not null;index" json:"status"`
	InputFingerprint        string                `gorm:"size:64;not null" json:"inputFingerprint"`
}

func (SKUBindingCalibration) TableName() string              { return "sku_binding_calibrations" }
...
type ManualBindingRequest struct {
	model.HardDeleteBase
	TenantID                int64                 `gorm:"not null;index:idx_manual_binding_requests_pending,priority:1;uniqueIndex:ux_manual_binding_requests_tenant_request_id,priority:1" json:"tenantId"`
	InventorySyncRunID      uuid.UUID             `gorm:"type:char(36);not null;index:idx_manual_binding_requests_run,priority:2" json:"inventorySyncRunId"`
	InventorySyncRun        InventorySyncRun      `gorm:"foreignKey:InventorySyncRunID;references:ID;constraint:OnUpdate:CASCADE,OnDelete:RESTRICT;" json:"-"`
	InventorySnapshotItemID uuid.UUID             `gorm:"type:char(36);not null" json:"inventorySnapshotItemId"`
	InventorySnapshotItem   InventorySnapshotItem `gorm:"foreignKey:InventorySnapshotItemID;references:ID;constraint:OnUpdate:CASCADE,OnDelete:RESTRICT;" json:"-"`
	ShopConnectionID        uuid.UUID             `gorm:"type:char(36);not null;index:idx_manual_binding_requests_pending,priority:2" json:"shopConnectionId"`
	ShopConnection          shop.Shop             `gorm:"foreignKey:ShopConnectionID;references:ID;constraint:OnUpdate:CASCADE,OnDelete:RESTRICT;" json:"-"`
	ExternalSKUID           string                `gorm:"column:external_sku_id;size:255;not null;index:idx_manual_binding_requests_pending,priority:3" json:"externalSkuId"`
	Status                  string                `gorm:"size:32;not null;index:idx_manual_binding_requests_pending,priority:4" json:"status"`
	...
	RequestID               string                `gorm:"size:128;not null;uniqueIndex:ux_manual_binding_requests_tenant_request_id,priority:2" json:"requestId"`
	IdempotencyKeyHash      string                `gorm:"size:64" json:"idempotencyKeyHash,omitempty"`
	InputFingerprint        string                `gorm:"size:64;not null" json:"inputFingerprint"`
	Revision                int                   `gorm:"not null;default:1" json:"revision"`
}

func (ManualBindingRequest) TableName() string { return "manual_binding_requests" }

type ManualBindingDecision struct {
	model.HardDeleteBase
	TenantID               int64                `gorm:"not null;uniqueIndex:ux_manual_binding_decisions_idempotency,priority:1;index:idx_manual_binding_decisions_request,priority:1" json:"tenantId"`
	ManualBindingRequestID uuid.UUID            `gorm:"type:char(36);not null;uniqueIndex:ux_manual_binding_decisions_idempotency,priority:2;index:idx_manual_binding_decisions_request,priority:2" json:"manualBindingRequestId"`
	...
	Operation              string               `gorm:"size:32;not null;uniqueIndex:ux_manual_binding_decisions_idempotency,priority:3" json:"operation"`
	IdempotencyKeyHash     string               `gorm:"size:64;not null;uniqueIndex:ux_manual_binding_decisions_idempotency,priority:4" json:"idempotencyKeyHash"`
...
func (ManualBindingDecision) TableName() string              { return "manual_binding_decisions" }
