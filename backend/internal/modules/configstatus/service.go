...
func (s *Service) Build(ctx context.Context) (*Overview, error) {
	...
	out.Items = append(out.Items, s.domainIdempotencyItem(ctx))
	out.Items = append(out.Items, s.orderSyncIdempotencyItem(ctx))
	out.Items = append(out.Items, s.orderImportIdempotencyItem(ctx))
	out.Items = append(out.Items, s.inventoryDeductIdempotencyItem(ctx))
	out.Items = append(out.Items, s.inventoryPushIdempotencyItem(ctx))
	out.Items = append(out.Items, s.publishIdempotencyItem(ctx))
	out.Items = append(out.Items, s.customerSendIdempotencyItem(ctx))
	out.Items = append(out.Items, s.aiBatchIdempotencyItem(ctx))
	out.Items = append(out.Items, s.taskLeaseItem(ctx))
	out.Items = append(out.Items, s.aiTextApplyIdempotencyItem(ctx))
	out.Items = append(out.Items, s.aiTextUndoIdempotencyItem(ctx))
	out.Items = append(out.Items, s.aiImageApplyIdempotencyItem(ctx))
	out.Items = append(out.Items, s.aiImageUndoIdempotencyItem(ctx))
	out.Items = append(out.Items, s.webhookHTTPReceiverItem(ctx))
	out.Items = append(out.Items, s.webhookSignatureItem(ctx))
	out.Items = append(out.Items, s.webhookReplayProtectionItem(ctx))
	out.Items = append(out.Items, s.collectWorkerLeaseItem(ctx))
	out.Items = append(out.Items, s.imageTaskWorkerLeaseItem(ctx))
	out.Items = append(out.Items, s.customerSyncWorkerLeaseItem(ctx))
	out.Items = append(out.Items, s.allWorkersLeaseItem(ctx))
	...
	out.Items = append(out.Items, s.douyinOAuthItem(ctx))
	out.Items = append(out.Items, s.douyinTokenItem(ctx))
	out.Items = append(out.Items, s.douyinCatalogItem(ctx))
	out.Items = append(out.Items, s.douyinImageItem(ctx))
	out.Items = append(out.Items, s.douyinDraftItem(ctx))
	out.Items = append(out.Items, s.douyinOrderItem(ctx))
	out.Items = append(out.Items, s.douyinInventoryItem(ctx))
	out.Items = append(out.Items, s.douyinCustomerItem(ctx))
	out.Items = append(out.Items, s.douyinWebhookItem(ctx))
	out.Items = append(out.Items, s.douyinReliabilitySummaryItem(ctx))
	out.Items = append(out.Items, s.douyinOrderWebhookItem(ctx))
	out.Items = append(out.Items, s.aiApplyReconciliationItem(ctx))
	out.Items = append(out.Items, s.douyinDraftReconciliationItem(ctx))
	out.Items = append(out.Items, s.douyinTokenRecoveryItem(ctx))
	out.Items = append(out.Items, s.douyinBrandItem(ctx))
	out.Items = append(out.Items, s.douyinWebhookContractItem(ctx))
	out.Items = append(out.Items, s.webhookResolverItem(ctx))
	out.Items = append(out.Items, s.webhookAppBindingItem(ctx))
	out.Items = append(out.Items, s.webhookTenantIsolationItem(ctx))
	out.Items = append(out.Items, s.webhookProductionFallbackItem(ctx))
	out.Items = append(out.Items, s.webhookConcurrencyItem(ctx))
	out.Items = append(out.Items, s.webhookRaceVerificationItem(ctx))
	out.Items = appendSecurityItems(out.Items, s.Config)
	out.Items = appendTenantSecurityItems(out.Items, s.Config)
	return out, nil
}
