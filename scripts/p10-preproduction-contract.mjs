...
export const P10_ENVIRONMENT_PROFILES = [
  'development', 'demo', 'performance', 'test', 'staging', 'production',
];
export const P10_PREPRODUCTION_APP_ENV = 'staging';

export const P10_DISABLED_CAPABILITY_KEYS = [
  'REAL_DOUYIN_ENABLED',
  'REAL_PLATFORM_READ',
  'REAL_PLATFORM_WRITE',
  'REAL_INVENTORY_READ',
  ...
  'CUSTOMER_MESSAGE_SYNC_QUEUE_ENABLED',
...
export function validateP10PreproductionContract(env = {}) {
  ...
  const checks = [
    ...
    ['environmentKnown', P10_ENVIRONMENT_PROFILES.includes(appEnv)],
    ['preproductionEnvironmentMapping', appEnv === P10_PREPRODUCTION_APP_ENV
...
export function validateP10ExternalInfrastructureEvidence(evidence = {}) {
  const checks = [
