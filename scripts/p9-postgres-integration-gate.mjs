...
export function validateP9PostgresIntegrationClosure(bundle = {}) {
  ...
  const checks = [
    ...
    ['skuSearchAuthenticationFailClosedPassed', contracts.skuSearchAuthenticationFailClosedPassed === true],
    ['skuSearchNormalTenantIsolationPassed', contracts.skuSearchNormalTenantIsolationPassed === true],
    ['skuSearchProductIDTenantIsolationPassed', contracts.skuSearchProductIDTenantIsolationPassed === true],
    ['skuSearchLimitWindowTenantIsolationPassed', contracts.skuSearchLimitWindowTenantIsolationPassed === true],
    ['manualBindingCrossTenantSelectedSKURejected', contracts.manualBindingCrossTenantSelectedSKURejected === true],
