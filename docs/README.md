...
| [P9_POSTGRESQL_INTEGRATION_CLOSURE.md](P9_POSTGRESQL_INTEGRATION_CLOSURE.md) / [p9-postgresql-integration-closure.json](p9-postgresql-integration-closure.json) | P9 PostgreSQL integration baseline closure evidence; P9 development closure remains not Production Ready | Backend / Product / AI Agent |
| [P9_BATCH_6_PREREQUISITE_TENANT_SCOPED_LOCAL_SKU_SEARCH_REPAIR.md](P9_BATCH_6_PREREQUISITE_TENANT_SCOPED_LOCAL_SKU_SEARCH_REPAIR.md) / [p9-batch-6-prerequisite-tenant-scoped-local-sku-search-repair.json](p9-batch-6-prerequisite-tenant-scoped-local-sku-search-repair.json) | P9-1004 prerequisite repair: existing local SKU search is trusted-context Tenant scoped and PostgreSQL/race/gate verified; Batch 6 Admin UI not started | Backend / Product / Security / AI Agent |
| [P9_TASK_BATCH_6_ADMIN_INVENTORY_CENTER.md](P9_TASK_BATCH_6_ADMIN_INVENTORY_CENTER.md) / [p9-task-batch-6-admin-inventory-center.json](p9-task-batch-6-admin-inventory-center.json) / [P9_TASK_BATCH_6_ADMIN_INVENTORY_CENTER_GATE.md](P9_TASK_BATCH_6_ADMIN_INVENTORY_CENTER_GATE.md) / [p9-task-batch-6-admin-inventory-center-gate.json](p9-task-batch-6-admin-inventory-center-gate.json) | P9 Product Batch 6 Admin Inventory Sync and Binding Center completed locally; fixture/mock Admin surface and P10 boundary preserved | Admin / Product / AI Agent |
| [P9_TASK_BATCH_7_INTEGRATION_DEVELOPMENT_CLOSURE.md](P9_TASK_BATCH_7_INTEGRATION_DEVELOPMENT_CLOSURE.md) / [p9-task-batch-7-integration-development-closure.json](p9-task-batch-7-integration-development-closure.json) / [P9_TASK_BATCH_7_INTEGRATION_DEVELOPMENT_CLOSURE_GATE.md](P9_TASK_BATCH_7_INTEGRATION_DEVELOPMENT_CLOSURE_GATE.md) / [p9-task-batch-7-integration-development-closure-gate.json](p9-task-batch-7-integration-development-closure-gate.json) | P9 Product Batch 7 Integration, Final Gates and Development Closure completed locally; binds PostgreSQL runtime, Admin E2E and platform boundary evidence | Backend / Admin / Product / AI Agent |
| [P9_FINAL_DEVELOPMENT_CLOSURE.md](P9_FINAL_DEVELOPMENT_CLOSURE.md) / [p9-final-development-closure.json](p9-final-development-closure.json) / [P9_FINAL_DEVELOPMENT_CLOSURE_GATE.md](P9_FINAL_DEVELOPMENT_CLOSURE_GATE.md) / [p9-final-development-closure-gate.json](p9-final-development-closure-gate.json) | P9 Development Complete and final development closure passed; production acceptance, tag, release, real Douyin/OAuth/credentials/platform I/O remain deferred | Product / Backend / Admin / AI Agent |
| [P9_CURRENT_HEAD_RECLOSURE.md](P9_CURRENT_HEAD_RECLOSURE.md) / [p9-current-head-reclosure.json](p9-current-head-reclosure.json) | P9 current-HEAD reclosure binds PostgreSQL and Batch 7 runtimes to the same live protected-source freeze; 38/38 tasks and 15/15 acceptance criteria passed with no source drift | Product / Backend / Security / AI Agent |
| [P9_TO_P10_TRANSITION.md](P9_TO_P10_TRANSITION.md) / [p9-to-p10-transition.json](p9-to-p10-transition.json) / [P9_TO_P10_TRANSITION_GATE.md](P9_TO_P10_TRANSITION_GATE.md) / [p9-to-p10-transition-gate.json](p9-to-p10-transition-gate.json) / [p9-protected-scope-manifest.json](p9-protected-scope-manifest.json) | P9 to P10 transition validates closure ancestry, artifact integrity, protected-scope changes, and live dirty-worktree source identity; current gate passed and permits P10 Planning only | Product / Backend / Security / AI Agent |
...
| [P9_SCOPE_DISCOVERY.md](P9_SCOPE_DISCOVERY.md) / [p9-scope-discovery.json](p9-scope-discovery.json) / [P9_OWNER_SCOPE_DECISION.md](P9_OWNER_SCOPE_DECISION.md) / [p9-owner-scope-decision.json](p9-owner-scope-decision.json) / [P9_EXECUTION_PLAN.md](P9_EXECUTION_PLAN.md) / [p9-execution-plan.json](p9-execution-plan.json) / [P9_FINAL_DEVELOPMENT_CLOSURE.md](P9_FINAL_DEVELOPMENT_CLOSURE.md) / [p9-final-development-closure.json](p9-final-development-closure.json) | P9 scope discovery, owner decision, execution plan, PostgreSQL integration, Admin Batch 6, Batch 7 integration gates, and final development closure. P9 Development Complete, `workingBranch=dev`, `committed=false`; P10 boundary preserved, not Production Ready | Product / Backend / Admin / Ops / AI Agent |
| [P10_PLANNING_PACK.md](P10_PLANNING_PACK.md) / [P10_OWNER_DECISION_PROPOSAL.md](P10_OWNER_DECISION_PROPOSAL.md) / [P10_EXECUTION_PLAN_DRAFT.md](P10_EXECUTION_PLAN_DRAFT.md) / [P10_ACCEPTANCE_CRITERIA_DRAFT.md](P10_ACCEPTANCE_CRITERIA_DRAFT.md) / [P10_RISK_REGISTER.md](P10_RISK_REGISTER.md) | Historical P10 planning pack, 15-decision proposal, execution/acceptance drafts, and risk register retained unchanged as planning history. | Owner / Product / Engineering / Ops / Security |
| [P10_OWNER_SCOPE_DECISION.md](P10_OWNER_SCOPE_DECISION.md) / [p10-owner-scope-decision.json](p10-owner-scope-decision.json) / [P10_PRODUCTION_BOUNDARY.md](P10_PRODUCTION_BOUNDARY.md) / [p10-production-boundary.json](p10-production-boundary.json) / [P10_EXECUTION_PLAN.md](P10_EXECUTION_PLAN.md) / [p10-execution-plan.json](p10-execution-plan.json) / [P10_ACCEPTANCE_CRITERIA.md](P10_ACCEPTANCE_CRITERIA.md) / [p10-acceptance-criteria.json](p10-acceptance-criteria.json) / [P10_OWNER_DECISION_GATE.md](P10_OWNER_DECISION_GATE.md) | Formal P10 Owner decision, approved L0-L3 boundary, nine-batch execution plan, 28 acceptance criteria, and Owner gate. Batch 1 is Ready to Start; implementation is Not Started; runtime remains L0 and not Production Ready. | Owner / Product / Backend / Admin / Ops / Security |
