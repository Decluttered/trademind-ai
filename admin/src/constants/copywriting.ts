...
export const COMMON_STATUS_LABEL: Record<string, string> = {
  ...
  need_check: 'Needs review',
  bound: 'Bound',
  unmatched: 'Unmatched',
  ambiguous: 'Manual confirmation required',
  skipped: 'Skipped',
  retryable: 'Retryable',
  ready: 'Ready',
  draft: 'Draft',
  draft_created: 'Platform draft created',
  ...
  draft_preparing: 'Preparing draft',
  pending_review: 'Pending review',
  approved: 'Approved',
  rejected: 'Rejected',
  execution_queued: 'Queued for execution',
  executing: 'Executing',
  draft_written: 'Draft created',
  execution_failed: 'Execution failed',
  editable: 'Editable',
  superseded: 'Replaced by a newer version',
  written: 'Written to draft',
  queued: 'Queued',
  succeeded: 'Completed',
  mock: 'Mock mode',
  sandbox: 'Sandbox mode',
  local_draft_only: 'Local draft only',
  real_draft_create: 'Create platform draft',
  blocked_by_real_credentials: 'Real credentials are missing',
  blocked_by_provider_config: 'Provider is not configured',
  unsupported_by_provider: 'Unsupported by the current provider',
  permission_denied: 'Permission denied',
  readonly_operation_forbidden: 'Read-only accounts cannot perform this action',
  store_permission_denied: 'No shop permission',
  inventory_sync_enabled: 'Inventory sync is enabled',
